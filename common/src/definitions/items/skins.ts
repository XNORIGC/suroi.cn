import { DefinitionType, type ItemDefinition, ObjectDefinitions } from "../../utils/objectDefinitions";
...
export const Skins = new ObjectDefinitions<SkinDefinition>([
    ...
    ...([
        ...
        ["Fireball",           undefined, 0xffc75a,  0xffc75a],
        ["Blueberry Smoothie", undefined, undefined, 0x5300ff],

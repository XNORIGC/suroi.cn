...
export const CVarCasters = Object.freeze({
    ...
    cv_weapon_compare: Casters.toBoolean,
    cv_weapon_compare_condensed: Casters.toBoolean,
    ...
    cv_explosion_shockwaves: Casters.toBoolean,
    cv_bullet_trail_bloom: Casters.toBoolean,
    cv_blood_splatter: Casters.toBoolean,
    cv_cooler_weapon_gas: Casters.toBoolean,
...
export const defaultClientCVars: SimpleCVarMapping = Object.freeze({
    ...
    cv_weapon_compare: false,
    cv_weapon_compare_condensed: false,
    ...
    cv_explosion_shockwaves: true,
    cv_bullet_trail_bloom: true,
    cv_blood_splatter: true,
    cv_cooler_weapon_gas: true,

...
export const CVarCasters = Object.freeze({
    ...
    cv_loadout_top_left_emote: Casters.toString,
    cv_loadout_top_emote: Casters.toString,
    cv_loadout_top_right_emote: Casters.toString,
    cv_loadout_bottom_right_emote: Casters.toString,
    cv_loadout_bottom_emote: Casters.toString,
    cv_loadout_bottom_left_emote: Casters.toString,
...
export const defaultClientCVars: SimpleCVarMapping = Object.freeze({
    ...
    cv_loadout_top_left_emote: "thumbs_up",
    cv_loadout_top_emote: "happy_face",
    cv_loadout_top_right_emote: "sad_face",
    cv_loadout_bottom_right_emote: "bleh",
    cv_loadout_bottom_emote: "suroi_logo",
    cv_loadout_bottom_left_emote: "joyful_face",

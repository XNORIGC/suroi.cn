...
export const CVarCasters = Object.freeze({
    ...
    cv_menu_music: Casters.generateUnionCaster(["follow_the_mode", "random", "main", "old", "halloween", "winter", "speaker", "main_full", "survivio", "survivio_halloween"]),

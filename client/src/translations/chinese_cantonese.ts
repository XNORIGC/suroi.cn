...
export const CHINESE_CANTONESE_TRANSLATIONS: TranslationMap = {
    ...
    "msg_try_again": "請重試。",
    "msg_punishment_warn": "警告！",
    "msg_punishment_warn_reason": "你已經被警告，因為：<reason>",
    "msg_punishment_temp": "暫時封禁通知",
    "msg_punishment_temp_reason": "我哋會將你暫時封禁，因為：<reason>",
    "msg_punishment_perma": "永久封禁通知",
    "msg_punishment_perma_reason": "我哋會將你永久封禁，原因：<reason>",
    "msg_no_reason": "俾唔到原因。",
    ...
    "lewis_gun": "Lewis輕機槍",
    "death_ray": "雷射槍",
    "mosin_nagant": "Mosin-Nagant狙擊槍",
    "cz600": "CZ-600狙擊槍",
    "firework_launcher": "逼擊炮",
    "destroyer_of_worlds": "核子武器",
    "revitalizer": "血量控制之槍",
    "g17_scoped": "G17手槍(裝咗倍鏡)",
    "vss": "VSS精確射手步槍",
    "sr25": "SR-25精確射手步槍",
    "pp19": "PP-19衝鋒槍(裝咗消音器)",
    "micro_uzi": "UZI衝鋒槍",

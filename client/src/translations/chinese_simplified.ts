...
export const CHINESE_SIMPLIFIED_TRANSLATIONS: TranslationMap = {
    ...
    "msg_error_joining_team": "加入队伍失败。<br>队伍可能不存在或已满。", // 此处的<br>是一个HTML换行元素。不 要 乱 碰 乱 动。
    "msg_try_again": "请重试。",
    "msg_warning": "你已被警告！",
    ...
    "play_squad": "小队游戏",
    "join_team": "加入队伍",
    "msg_locked_tooltip": "由于没有足够的玩家来同时进行多种游戏，游戏每天切换一次。",
    ...
    "settings_performance_warning": "* 此设置可能会在某些设备上导致问题。若你无法加入游戏，请尝试禁用此设置。",
    ...
    "msg_not_enough_space": "空间不足！",
    "msg_item_already_equipped": "已装备此物品！",
    "msg_better_item_equipped": "已装备更好的物品！",
    "msg_cannot_use_radio": "无法在室内使用无线电！",
    ...
    "tt_reduces": "<item>受到的伤害减少<percent>%",
    ...
    "emote_sad_face": "不满",
    "emote_thumbs_up": "大拇指",
    "emote_thumbs_down": "倒拇指",
    "emote_wave": "挥手",
    "emote_disappointed_face": "沮丧",
    "emote_sobbing_face": "大哭",
    "emote_angry_face": "生气",
    "emote_heart_face": "花痴",
    "emote_joyful_face": "笑哭",
    "emote_cool_face": "墨镜",
    "emote_upside_down_face": "倒笑",
    "emote_picasso_face": "毕加索",
    "emote_alien": "外星人",
    "emote_headshot": "爆头",
    "emote_dab": "嘻哈超人舞",
    "emote_devil_face": "恶魔",
    ...
    "emote_greedy_face": "贪婪",
    "emote_creepy_clown": "恐怖小丑",
    "emote_lying_face": "说谎",
    "emote_skull": "骷髅",
    "emote_melting_face": "融化",
    "emote_grimacing_face": "咬牙",
    "emote_vomiting_face": "呕吐",
    "emote_screaming_face": "尖叫",
    "emote_pleading_face": "恳求",
    "emote_sad_smiling_face": "含泪笑",
    "emote_triumphant_face": "傲慢",
    "emote_questioning_face": "挑眉",
    "emote_smirking_face": "得意",
    "emote_blushing_face": "羞涩",
    "emote_saluting_face": "敬礼",
    "emote_neutral_face": "冷漠",
    "emote_relieved_face": "苦笑",
    "emote_monocle_face": "怀疑",
    "emote_partying_face": "派对",
    "emote_shushing_face": "嘘",
    ...
    "emote_bleh": "略",
    "emote_muller": "穆勒",
    "emote_suroi_general_chat": "Suroi通用聊天",
    "emote_fire": "火",
    "emote_rip": "安息吧",
    "emote_leosmug": "莱昂得意",
    "emote_socks": "袜子",
    ...
    "badge_moderatr": "管理员",
    "badge_administratr": "行政员",
    "badge_youtubr": "Youtubr",
    "badge_boostr": "赞助者",
    "badge_ownr": "所有者",
    "badge_bleh": "略",
    "badge_froog": "青蛙",
